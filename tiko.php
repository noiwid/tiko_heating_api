      ...
      if($_REQUEST["install"]){
         ...
         if(is_array($heaters))
            foreach($heaters as $k=>$v){
               ...
               $array["shell_command"][clean($v)."_set_temp"] = '/usr/bin/curl -k -X POST '.$baseurl.'&room_id='.$k.'&temperature={{ state_attr("climate.'.clean($v).'", "temperature") }}';
            ...
            $array["command_line"][] = array(
               "sensor"=>array(
                 ...
                 "command" => "/usr/bin/curl -k -s '".$baseurl."&consumption=true'",
            ...
            $array["command_line"][] = array(
               "sensor"=>array(
                 ...
                 "json_attributes"=> 
                    $my_sensors,
                 "command" => "/usr/bin/curl -k -s '".$baseurl."'",
                 "scan_interval" => 60,
                 "value_template" => 1
                )
            );
            $array["command_line"][] = array(
              "switch"=>array(
                  ...
                  "command_on"=>"/usr/bin/curl -k -g '".$baseurl."&mode=0'",
                  "command_off"=>"/usr/bin/curl -k -g '".$baseurl."&mode=disableHeating'",
                  "command_state"=>"/usr/bin/curl -k -g '".$baseurl."'",
            ...
            $array["command_line"][] = array(
              "switch"=>array(
                  "name"=>"Radiateurs off",
                  "command_on"=>"/usr/bin/curl -k -g '".$baseurl."&mode=disableHeating'",
                  "command_off"=>"/usr/bin/curl -k -g '".$baseurl."&mode=0'",
                  "command_state"=>"/usr/bin/curl -k -g '".$baseurl."'",
                  "value_template"=>'{{value_json["disableHeating"]}}',
                  "scan_interval" => 60,
                  "icon"=>"{% if (value_json.disableHeating) %} mdi:radiator-off {% else %} mdi:radiator-off {% endif %}",
            ...
            $array["command_line"][] = array(
              "switch"=>array(
                  ...
                  "command_on"=>"/usr/bin/curl -k -g '".$baseurl."&mode=boost'",
                  "command_off"=>"/usr/bin/curl -k -g '".$baseurl."&mode=0'",
                  "command_state"=>"/usr/bin/curl -k -g '".$baseurl."'",
            ...
            $array["command_line"][] = array(
              "switch"=>array(
                  ...
                  "command_on"=>"/usr/bin/curl -k -g '".$baseurl."&mode=absence'",
                  "command_off"=>"/usr/bin/curl -k -g '".$baseurl."&mode=0'",
                  "command_state"=>"/usr/bin/curl -k -g '".$baseurl."'",
            ...
            $array["command_line"][] = array(
              "switch"=>array(
                  ...
                  "command_on"=>"/usr/bin/curl -k -g '".$baseurl."&mode=frost'",
                  "command_off"=>"/usr/bin/curl -k -g '".$baseurl."&mode=0'",
                  "command_state"=>"/usr/bin/curl -k -g '".$baseurl."'",
